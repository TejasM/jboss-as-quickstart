kitchensink-controlleradvice: Kitchensink ControllerAdvice Example using Spring 3.2
...
In addition, this version of kitchensink showcases the use of @ControllerAdvice annotation, introduced in the Spring 3.2.
